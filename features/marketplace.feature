Feature: Checkout an item from marketplace
    ...
    Scenario: User checkout an item
        ...
        When I select product 'color' variant with 'Black'
        ...
        And Product with variant '128 GB, Black' displayed on the checkout page
        When I check and remove promo if exist
        And I click pay button on the checkout page
